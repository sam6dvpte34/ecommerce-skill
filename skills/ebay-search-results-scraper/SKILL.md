---
name: ebay-search-results-scraper
description: "Collect search results from eBay — product titles, prices, ratings, URLs, sponsored flags. Use when the user wants to collect listings matching a keyword or category."
---

# eBay Search Results Scraper with BrowserAct

Use this Skill for eBay search result collection.
...
- "Scrape eBay search results for this keyword and export product titles, prices, positions, and URLs."
- "Collect search results from these eBay URLs and return a table."
