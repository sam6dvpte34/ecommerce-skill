---
name: temu-price-discount-monitor
...
# Temu Price Discount Monitor with BrowserAct

Use this Skill for Temu price and discount monitoring.
...
- "Monitor this Temu page for visible price, stock, discount, and availability changes."
- "Collect current price and availability data from these Temu URLs."
