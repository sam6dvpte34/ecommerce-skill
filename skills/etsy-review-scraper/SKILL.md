---
name: etsy-review-scraper
description: "Collect reviews from Etsy — text, rating, author, date, verified status. Use when the user wants to collect reviews for sentiment analysis or quality research."
---

# Etsy Review Scraper with BrowserAct

Use this Skill for Etsy review collection.
...
- "Scrape visible Etsy reviews and export rating, review text, date, and source URL."
- "Collect reviews from these Etsy pages and return a table."
