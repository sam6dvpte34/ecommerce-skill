---
name: flipkart-category-listing-scraper
description: "Collect category listings from Flipkart — product titles, prices, ratings, category filters. Use when the user wants to collect products from a category or browse page."
---

# Flipkart Category Listing Scraper with BrowserAct

Use this Skill for Flipkart category listing collection.
...
- "Scrape this Flipkart listing page and export visible product cards with prices and source URLs."
- "Collect category listings from these Flipkart URLs and return a table."
