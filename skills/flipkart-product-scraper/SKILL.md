...
description: "Collect products from Flipkart — title, price, specs, images, availability. Use when the user wants to research products or collect catalog data."
---

# Flipkart Product Scraper with BrowserAct

Use this Skill for Flipkart product collection.
...
- "Scrape this Flipkart page and export title, price, availability, rating, seller, and source URL."
- "Collect Flipkart product or listing details from these URLs and return a table."
- "Find visible price, stock, variant, promotion, and seller data from these pages."
- "Compare these Flipkart pages and return seller, price, shipping, and source differences."
