...
description: "Collect reviews from Amazon — text, rating, author, date, verified status. Use when the user wants to collect reviews for sentiment analysis or quality research."
---

# Amazon Review Scraper with BrowserAct

Use this Skill for Amazon review collection.
...
- "Scrape visible Amazon reviews and export rating, review text, date, and source URL."
- "Collect reviews from these Amazon pages and return a table."
