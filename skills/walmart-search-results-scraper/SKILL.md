---
name: walmart-search-results-scraper
description: "Collect search results from Walmart — product titles, prices, ratings, URLs, sponsored flags. Use when the user wants to collect listings matching a keyword or category."
---

# Walmart Search Results Scraper with BrowserAct

Use this Skill for Walmart search result collection.
...
- "Scrape Walmart search results for this keyword and export product titles, prices, positions, and URLs."
- "Collect search results from these Walmart URLs and return a table."
