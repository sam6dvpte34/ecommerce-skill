...
description: "Collect scraper data from Yahoo Auctions Japan. Use when the user wants to research or export scraper content."
---

# Yahoo Auctions Japan Scraper with BrowserAct

Use this Skill for Yahoo Auctions Japan collection.
...
- "Scrape this Yahoo Auctions Japan page and export title, price, availability, rating, seller, and source URL."
- "Collect Yahoo Auctions Japan product or listing details from these URLs and return a table."
- "Find visible price, stock, variant, promotion, and seller data from these pages."
- "Compare these Yahoo Auctions Japan pages and return seller, price, shipping, and source differences."
