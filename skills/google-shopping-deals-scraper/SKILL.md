---
name: google-shopping-deals-scraper
description: "Collect deals from Google Shopping — deal title, discount, original price, merchant. Use when the user wants to collect current deals and promotions."
---

# Google Shopping Deals Scraper with BrowserAct

Use this Skill for Google Shopping deal collection.
...
- "Scrape visible Google Shopping offers and export product title, sale price, discount, seller, and source URL."
- "Collect deal or promotion data from these Google Shopping pages and return a table."
