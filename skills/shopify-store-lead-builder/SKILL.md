---
name: shopify-store-lead-builder
...
# Shopify Store Lead Builder with BrowserAct

Use this Skill for Shopify store lead research.
...
- "Scrape this Shopify seller or supplier profile and export visible profile information."
- "Collect seller references from these Shopify pages and return a table."
