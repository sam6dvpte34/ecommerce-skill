---
name: alibaba-product-detail-scraper
...
# Alibaba Product Detail Scraper with BrowserAct

Use this Skill for Alibaba product detail collection.
...
- "Scrape this Alibaba page and export title, price, availability, rating, seller, and source URL."
- "Collect Alibaba product or listing details from these URLs and return a table."
- "Find visible price, stock, variant, promotion, and seller data from these pages."
- "Compare these Alibaba pages and return seller, price, shipping, and source differences."
