...
description: "Collect reviews from Trustpilot — text, rating, author, date, verified status. Use when the user wants to collect reviews for sentiment analysis or quality research."
---

# Trustpilot Review Scraper with BrowserAct

Use this Skill for Trustpilot review collection.
...
- "Scrape visible Trustpilot reviews and export rating, review text, date, and source URL."
- "Collect reviews from these Trustpilot pages and return a table."
