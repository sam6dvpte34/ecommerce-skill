---
name: noon-search-results-scraper
description: "Collect search results from Noon — product titles, prices, ratings, URLs, sponsored flags. Use when the user wants to collect listings matching a keyword or category."
---

# Noon Search Results Scraper with BrowserAct

Use this Skill for Noon search result collection.
...
- "Scrape Noon search results for this keyword and export product titles, prices, positions, and URLs."
- "Collect search results from these Noon URLs and return a table."
