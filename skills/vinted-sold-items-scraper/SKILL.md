    ---
    name: vinted-sold-items-scraper
    description: "Collect Vinted sold items — title, sold price, brand, size, condition, seller. Use when the user wants resale fashion price research."
    license: MIT
    metadata:
    ...
    Use this Skill for Vinted sold item research, fashion resale comp analysis, and brand demand monitoring.
    ...
    - Collect visible Vinted sold or comparable listings
- Research resale fashion prices by brand, size, and condition
- Compare demand signals across categories or styles
- Export sold comp records with source links

    ## Common Data

    Depending on what is visible and authorized, relevant fields can include:

    - Item title, URL, sold price, brand, size, condition, seller, and image reference
- Likes, listing date, shipping context, and status when visible
...
separate approval for dependency installation.
    ...
    - "Run vinted-sold-items-scraper and export the visible records to a table."
- "Collect vinted sold items scraper data from these URLs."
- "Research these targets with vinted-sold-items-scraper and include source links."
