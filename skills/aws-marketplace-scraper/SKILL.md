---
name: aws-marketplace-scraper
description: "Collect scraper data from AWS Marketplace. Use when the user wants to research or export scraper content."
---

# AWS Marketplace Scraper with BrowserAct

Use this Skill for AWS Marketplace listing collection.
...
- "Scrape this AWS Marketplace page and export title, price, availability, rating, seller, and source URL."
- "Collect AWS Marketplace product or listing details from these URLs and return a table."
- "Find visible price, stock, variant, promotion, and seller data from these pages."
- "Compare these AWS Marketplace pages and return seller, price, shipping, and source differences."
