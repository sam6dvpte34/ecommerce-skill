---
name: ecommerce-competitor-assortment-monitor
...
# Ecommerce Competitor Assortment Monitor with BrowserAct

Use this Skill for Competitor assortment and shelf coverage monitoring.
...
- Monitor competitor assortment, shelf coverage, and visible product changes
- Research product gaps, overlaps, new listings, and removed listings
- Compare category coverage across stores or marketplaces
- Build source-linked assortment tracking datasets

## Common Data

Depending on what is visible and authorized, relevant fields can include:

- Product title, brand, category, collection, listing status, and visible shelf position
- Price, stock, variant, seller, promotion, and availability signals
- New, removed, overlapping, and changed product references when prior snapshots are supplied
- Source URL, product URL, listing context, and capture timestamp
