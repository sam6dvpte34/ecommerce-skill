    ---
    name: shopify-product-recommendations-scraper
    description: "Collect Shopify recommendation widgets — related products, upsells, bundles, prices. Use when the user wants merchandising or cross-sell research."
    license: MIT
    metadata:
    ...
    # Shopify Product Recommendations Scraper

    Use this Skill for Shopify recommendation, upsell, cross-sell, and merchandising research.
    ...
    - Collect visible related products and recommendation widgets
- Research cross-sell, upsell, bundle, and merchandising patterns
- Compare product recommendation logic across stores
- Export recommended product records with context

    ## Common Data

    Depending on what is visible and authorized, relevant fields can include:

    - Source product URL, recommended product title, URL, price, image, and position
- Widget label, collection context, variant or bundle context when visible
- Store domain and page metadata
...
separate approval for dependency installation.
    ...
    - "Run shopify-product-recommendations-scraper and export the visible records to a table."
- "Collect shopify product recommendations scraper data from these URLs."
- "Research these targets with shopify-product-recommendations-scraper and include source links."
