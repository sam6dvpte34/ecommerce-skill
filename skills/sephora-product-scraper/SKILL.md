---
name: sephora-product-scraper
description: "Collect products from Sephora — title, price, specs, images, availability. Use when the user wants to research products or collect catalog data."
---

# Sephora Product Scraper with BrowserAct

Use this Skill for Sephora product collection.
...
- "Scrape this Sephora page and export title, price, availability, rating, seller, and source URL."
- "Collect Sephora product or listing details from these URLs and return a table."
- "Find visible price, stock, variant, promotion, and seller data from these pages."
- "Compare these Sephora pages and return seller, price, shipping, and source differences."
