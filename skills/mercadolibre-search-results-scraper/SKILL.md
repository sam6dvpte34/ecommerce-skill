---
name: mercadolibre-search-results-scraper
description: "Collect search results from MercadoLibre — product titles, prices, ratings, URLs, sponsored flags. Use when the user wants to collect listings matching a keyword or category."
---

# MercadoLibre Search Results Scraper with BrowserAct

Use this Skill for MercadoLibre search result collection.
...
- "Scrape MercadoLibre search results for this keyword and export product titles, prices, positions, and URLs."
- "Collect search results from these MercadoLibre URLs and return a table."
