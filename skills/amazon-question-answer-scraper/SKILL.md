    ---
    name: amazon-question-answer-scraper
    description: "Collect Amazon Q&A — questions, answers, votes, dates, product URL. Use when the user wants buyer objection or product FAQ research."
    license: MIT
    metadata:
    ...
    Use this Skill for Amazon product Q&A collection, buyer objection mining, and product content research.
    ...
    - Collect visible questions and answers from Amazon product pages
- Mine buyer objections, sizing questions, compatibility concerns, and use cases
- Compare recurring questions across products or competitors
- Export Q&A records with product source links

    ## Common Data

    Depending on what is visible and authorized, relevant fields can include:

    - Question text, answer text, votes, dates, asker or respondent context when visible
- Product title, ASIN, URL, category, and page metadata
- Answer count, helpfulness signals, and source references
...
separate approval for dependency installation.
    ...
    - "Run amazon-question-answer-scraper and export the visible records to a table."
- "Collect amazon question answer scraper data from these URLs."
- "Research these targets with amazon-question-answer-scraper and include source links."
