    ---
    name: shopee-search-results-scraper
    description: "Collect Shopee search results — product titles, prices, sellers, sold counts, ratings. Use when the user wants marketplace keyword research."
    license: MIT
    metadata:
    ...
    # Shopee Search Results Scraper

    Use this Skill for Shopee search result collection, keyword research, and marketplace ranking analysis.
    ...
    - Collect visible Shopee search result listings
- Research products, sellers, prices, sold counts, and rank positions
- Compare keyword result pages across categories or regions
- Export result datasets with source links

    ## Common Data

    Depending on what is visible and authorized, relevant fields can include:

    - Keyword, rank, product title, URL, price, seller, sold count, rating, and review count
- Voucher labels, shipping, location, image, and category context
...
separate approval for dependency installation.
    ...
    - "Run shopee-search-results-scraper and export the visible records to a table."
- "Collect shopee search results scraper data from these URLs."
- "Research these targets with shopee-search-results-scraper and include source links."
