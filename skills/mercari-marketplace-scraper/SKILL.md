---
name: mercari-marketplace-scraper
description: "Collect marketplace listings from Mercari — item title, price, condition, seller, category. Use when the user wants to collect listings from a peer-to-peer marketplace."
---

# Mercari Marketplace Scraper with BrowserAct

Use this Skill for Mercari marketplace collection.
...
- "Scrape this Mercari listing page and export visible product cards with prices and source URLs."
- "Collect category listings from these Mercari URLs and return a table."
