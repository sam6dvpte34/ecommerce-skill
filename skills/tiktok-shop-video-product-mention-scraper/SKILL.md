    ---
    name: tiktok-shop-video-product-mention-scraper
    description: "Collect TikTok Shop product mentions in videos — product, creator, video URL, views, engagement. Use when the user wants social commerce research."
    license: MIT
    metadata:
    ...
    # TikTok Shop Video Product Mention Scraper

    Use this Skill for TikTok Shop video commerce research, creator-product mapping, and product mention collection.
    ...
    - Collect videos that mention or link target TikTok Shop products
- Research creator-driven sales signals and content formats
- Compare product exposure across creators or keywords
- Export video-product mention records

    ## Common Data

    Depending on what is visible and authorized, relevant fields can include:

    - Product title, product URL, creator, video URL, caption, views, likes, comments, and timestamp
- Shop or seller context, hashtags, music, and source references
...
separate approval for dependency installation.
    ...
    - "Run tiktok-shop-video-product-mention-scraper and export the visible records to a table."
- "Collect tiktok shop video product mention scraper data from these URLs."
- "Research these targets with tiktok-shop-video-product-mention-scraper and include source links."
