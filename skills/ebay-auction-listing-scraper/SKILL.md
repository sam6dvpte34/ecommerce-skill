---
name: ebay-auction-listing-scraper
description: "Collect auction listings from eBay — title, current bid, bids, end time, seller. Use when the user wants to track active auctions and bidding activity."
---

# eBay Auction Listing Scraper with BrowserAct

Use this Skill for eBay auction listing collection.
...
- "Scrape this eBay listing page and export visible product cards with prices and source URLs."
- "Collect category listings from these eBay URLs and return a table."
