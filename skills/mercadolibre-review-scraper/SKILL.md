...
description: "Collect reviews from MercadoLibre — text, rating, author, date, verified status. Use when the user wants to collect reviews for sentiment analysis or quality research."
---

# MercadoLibre Review Scraper with BrowserAct

Use this Skill for MercadoLibre review collection.
...
- "Scrape visible MercadoLibre reviews and export rating, review text, date, and source URL."
- "Collect reviews from these MercadoLibre pages and return a table."
