---
name: naver-shopping-seller-scraper
description: "Collect seller data from Naver Shopping. Use when the user wants to research or export seller content."
---

# Naver Shopping Seller Scraper with BrowserAct

Use this Skill for Naver Shopping seller collection.
...
- "Scrape this Naver Shopping seller or supplier profile and export visible profile information."
- "Collect seller references from these Naver Shopping pages and return a table."
