---
name: google-shopping-search-results-scraper
description: "Collect search results from Google Shopping — product titles, prices, ratings, URLs, sponsored flags. Use when the user wants to collect listings matching a keyword or category."
---

# Google Shopping Search Results Scraper with BrowserAct

Use this Skill for Google Shopping search result collection.
...
- "Scrape Google Shopping search results for this keyword and export product titles, prices, positions, and URLs."
- "Collect search results from these Google Shopping URLs and return a table."
