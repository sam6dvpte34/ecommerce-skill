---
name: tiktok-shop-review-scraper
description: "Collect reviews from TikTok Shop — text, rating, author, date, verified status. Use when the user wants to collect reviews for sentiment analysis or quality research."
---

# TikTok Shop Review Scraper with BrowserAct

Use this Skill for TikTok Shop review collection.
...
- "Scrape visible TikTok Shop reviews and export rating, review text, date, and source URL."
- "Collect reviews from these TikTok Shop pages and return a table."
