...
description: "Collect products from Costco — title, price, specs, images, availability. Use when the user wants to research products or collect catalog data."
---

# Costco Product Scraper with BrowserAct

Use this Skill for Costco product collection.
...
- "Scrape this Costco page and export title, price, availability, rating, seller, and source URL."
- "Collect Costco product or listing details from these URLs and return a table."
- "Find visible price, stock, variant, promotion, and seller data from these pages."
- "Compare these Costco pages and return seller, price, shipping, and source differences."
