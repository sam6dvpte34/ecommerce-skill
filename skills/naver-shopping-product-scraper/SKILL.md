---
name: naver-shopping-product-scraper
description: "Collect products from Naver Shopping — title, price, specs, images, availability. Use when the user wants to research products or collect catalog data."
---

# Naver Shopping Product Scraper with BrowserAct

Use this Skill for Naver Shopping product collection.
...
- "Scrape this Naver Shopping page and export title, price, availability, rating, seller, and source URL."
- "Collect Naver Shopping product or listing details from these URLs and return a table."
- "Find visible price, stock, variant, promotion, and seller data from these pages."
- "Compare these Naver Shopping pages and return seller, price, shipping, and source differences."
