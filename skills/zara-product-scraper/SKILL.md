---
name: zara-product-scraper
description: "Collect products from Zara — title, price, specs, images, availability. Use when the user wants to research products or collect catalog data."
---

# Zara Product Scraper with BrowserAct

Use this Skill for Zara product collection.
...
- "Scrape this Zara page and export title, price, availability, rating, seller, and source URL."
- "Collect Zara product or listing details from these URLs and return a table."
- "Find visible price, stock, variant, promotion, and seller data from these pages."
- "Compare these Zara pages and return seller, price, shipping, and source differences."
