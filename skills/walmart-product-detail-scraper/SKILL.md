---
name: walmart-product-detail-scraper
description: "Collect product details from Walmart — title, price, specs, images, availability, seller. Use when the user wants to research products, compare listings, or build a product dataset."
---

# Walmart Product Detail Scraper with BrowserAct

Use this Skill for Walmart product detail collection.
...
- "Scrape this Walmart page and export title, price, availability, rating, seller, and source URL."
- "Collect Walmart product or listing details from these URLs and return a table."
- "Find visible price, stock, variant, promotion, and seller data from these pages."
- "Compare these Walmart pages and return seller, price, shipping, and source differences."
