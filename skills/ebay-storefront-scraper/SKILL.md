---
name: ebay-storefront-scraper
description: "Collect storefronts from eBay — store name, branding, featured products, ratings. Use when the user wants to research brand storefronts or competitive assortment."
---

# eBay Storefront Scraper with BrowserAct

Use this Skill for eBay storefront collection.
...
- "Scrape this eBay page and export title, price, availability, rating, seller, and source URL."
- "Collect eBay product or listing details from these URLs and return a table."
- "Find visible price, stock, variant, promotion, and seller data from these pages."
- "Compare these eBay pages and return seller, price, shipping, and source differences."
