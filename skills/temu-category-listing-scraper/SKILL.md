---
name: temu-category-listing-scraper
description: "Collect category listings from Temu — product titles, prices, ratings, category filters. Use when the user wants to collect products from a category or browse page."
---

# Temu Category Listing Scraper with BrowserAct

Use this Skill for Temu category listing collection.
...
- "Scrape this Temu listing page and export visible product cards with prices and source URLs."
- "Collect category listings from these Temu URLs and return a table."
