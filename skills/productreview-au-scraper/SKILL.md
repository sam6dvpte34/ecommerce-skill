---
name: productreview-au-scraper
description: "Collect scraper data from ProductReview.com.au. Use when the user wants to research or export scraper content."
---

# ProductReview.com.au Scraper with BrowserAct

Use this Skill for ProductReview.com.au review collection.
...
- "Scrape this ProductReview.com.au page and export title, price, availability, rating, seller, and source URL."
- "Collect ProductReview.com.au product or listing details from these URLs and return a table."
- "Find visible price, stock, variant, promotion, and seller data from these pages."
- "Compare these ProductReview.com.au pages and return seller, price, shipping, and source differences."
