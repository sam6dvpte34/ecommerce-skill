...
description: "Collect reviews from Lazada — text, rating, author, date, verified status. Use when the user wants to collect reviews for sentiment analysis or quality research."
---

# Lazada Review Scraper with BrowserAct

Use this Skill for Lazada review collection.
...
- "Scrape visible Lazada reviews and export rating, review text, date, and source URL."
- "Collect reviews from these Lazada pages and return a table."
