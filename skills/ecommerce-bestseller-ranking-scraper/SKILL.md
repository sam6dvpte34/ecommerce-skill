---
name: ecommerce-bestseller-ranking-scraper
description: "Collect bestseller rankings from any ecommerce site — ranked products, positions, category. Use when the user wants to track what's selling best in a category."
---

# Ecommerce Bestseller Ranking Scraper with BrowserAct

Use this Skill for Bestseller and ranking page collection.
...
- "Scrape this ecommerce seller or supplier profile and export visible profile information."
- "Collect seller references from these ecommerce pages and return a table."
