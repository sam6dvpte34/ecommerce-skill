    ...
    description: "Collect Rakuten product pages — title, price, seller, points, availability, reviews. Use when the user wants Japan marketplace research."
    license: MIT
    metadata:
    ...
    Use this Skill for Rakuten product data collection, Japan marketplace research, and price comparison.
    ...
    - Collect visible Rakuten product details
- Research pricing, points, availability, seller, and reviews
- Compare products across Rakuten shops or categories
- Export product records with source links
    ...
    - Product title, URL, price, points, seller, availability, rating, and review count
- Shipping, coupons, category, variants, and images when visible
...
separate approval for dependency installation.
    ...
    - "Run rakuten-product-scraper and export the visible records to a table."
- "Collect rakuten product scraper data from these URLs."
- "Research these targets with rakuten-product-scraper and include source links."
