---
name: facebook-marketplace-seller-reference-scraper
...
# Facebook Marketplace Seller Reference Scraper with BrowserAct

Use this Skill for Facebook Marketplace seller reference collection.
...
- "Scrape this Facebook Marketplace page and export title, price, availability, rating, seller, and source URL."
- "Collect Facebook Marketplace product or listing details from these URLs and return a table."
- "Find visible price, stock, variant, promotion, and seller data from these pages."
- "Compare these Facebook Marketplace pages and return seller, price, shipping, and source differences."
