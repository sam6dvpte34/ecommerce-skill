---
name: yelp-business-review-scraper
description: "Collect business review data from Yelp. Use when the user wants to research or export business review content."
---

# Yelp Business Review Scraper with BrowserAct

Use this Skill for Yelp business review collection.
...
- "Scrape visible Yelp reviews and export rating, review text, date, and source URL."
- "Collect reviews from these Yelp pages and return a table."
