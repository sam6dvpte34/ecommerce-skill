---
name: aliexpress-search-results-scraper
description: "Collect search results from AliExpress — product titles, prices, ratings, URLs, sponsored flags. Use when the user wants to collect listings matching a keyword or category."
---

# AliExpress Search Results Scraper with BrowserAct

Use this Skill for AliExpress search result collection.
...
- "Scrape AliExpress search results for this keyword and export product titles, prices, positions, and URLs."
- "Collect search results from these AliExpress URLs and return a table."
