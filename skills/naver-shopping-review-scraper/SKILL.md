---
name: naver-shopping-review-scraper
description: "Collect reviews from Naver Shopping — text, rating, author, date, verified status. Use when the user wants to collect reviews for sentiment analysis or quality research."
---

# Naver Shopping Review Scraper with BrowserAct

Use this Skill for Naver Shopping review collection.
...
- "Scrape visible Naver Shopping reviews and export rating, review text, date, and source URL."
- "Collect reviews from these Naver Shopping pages and return a table."
