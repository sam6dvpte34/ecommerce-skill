...
description: "Collect products from Zalando — title, price, specs, images, availability. Use when the user wants to research products or collect catalog data."
---

# Zalando Product Scraper with BrowserAct

Use this Skill for Zalando product collection.
...
- "Scrape this Zalando page and export title, price, availability, rating, seller, and source URL."
- "Collect Zalando product or listing details from these URLs and return a table."
- "Find visible price, stock, variant, promotion, and seller data from these pages."
- "Compare these Zalando pages and return seller, price, shipping, and source differences."
