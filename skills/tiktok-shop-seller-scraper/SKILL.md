...
- "Scrape this TikTok Shop seller or supplier profile and export visible profile information."
- "Collect seller references from these TikTok Shop pages and return a table."
