...
# eBay Review Scraper with BrowserAct

Use this Skill for eBay review collection.
...
- "Scrape visible eBay reviews and export rating, review text, date, and source URL."
- "Collect reviews from these eBay pages and return a table."
