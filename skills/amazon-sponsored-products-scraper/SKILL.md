    ---
    name: amazon-sponsored-products-scraper
    description: "Collect Amazon sponsored product placements — keyword, rank, ASIN, title, price, seller. Use when the user wants ad visibility or competitor research."
    license: MIT
    metadata:
    ...
    Use this Skill for Amazon sponsored product research, keyword ad visibility checks, and competitor ad monitoring.
    ...
    - Collect sponsored placements from Amazon search or category pages
- Research competitor ad visibility by keyword
- Compare sponsored products by rank, price, reviews, and seller
- Export ad placement records for paid search analysis

    ## Common Data

    Depending on what is visible and authorized, relevant fields can include:

    - Keyword, placement rank, ASIN, title, product URL, price, and seller
- Sponsored label, rating, review count, image, coupon, and delivery signal
- Search URL, category context, and timestamp
...
separate approval for dependency installation.
    ...
    - "Run amazon-sponsored-products-scraper and export the visible records to a table."
- "Collect amazon sponsored products scraper data from these URLs."
- "Research these targets with amazon-sponsored-products-scraper and include source links."
