    ---
    name: shopify-abandoned-cart-flow-surface-scraper
    description: "Collect visible Shopify cart recovery surfaces — cart messages, checkout prompts, discounts. Use when the user wants funnel or CRO research."
    license: MIT
    metadata:
    ...
    # Shopify Abandoned Cart Flow Surface Scraper

    Use this Skill for Shopify cart and checkout surface research, CRO analysis, and promo funnel monitoring.
    ...
    - Capture visible cart, checkout, and recovery-related messages
- Research urgency, discount, free shipping, and trust-building prompts
- Compare cart UX and conversion surfaces across stores
- Export funnel surface records with screenshots when useful

    ## Common Data

    Depending on what is visible and authorized, relevant fields can include:

    - Store domain, cart URL, message text, promo offer, shipping threshold, and source context
- Product context, checkout step, trust badges, payment labels, and timestamp
...
separate approval for dependency installation.
    ...
    - "Run shopify-abandoned-cart-flow-surface-scraper and export the visible records to a table."
- "Collect shopify abandoned cart flow surface scraper data from these URLs."
- "Research these targets with shopify-abandoned-cart-flow-surface-scraper and include source links."
