---
name: ecommerce-category-listing-scraper
description: "Collect category listings from any ecommerce site — product titles, prices, ratings, filters. Use when the user wants to map what a store carries in a category."
---

# Ecommerce Category Listing Scraper with BrowserAct

Use this Skill for Generic category listing collection.
...
- "Scrape this ecommerce listing page and export visible product cards with prices and source URLs."
- "Collect category listings from these ecommerce URLs and return a table."
