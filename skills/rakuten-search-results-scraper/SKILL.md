    ---
    name: rakuten-search-results-scraper
    description: "Collect Rakuten search results — products, prices, shops, points, ratings, ranks. Use when the user wants Japan marketplace keyword research."
    license: MIT
    metadata:
    ...
    # Rakuten Search Results Scraper

    Use this Skill for Rakuten search result collection, keyword research, and marketplace ranking analysis.
    ...
    - Collect visible Rakuten search result listings
- Research products, shops, prices, points, and rank positions
- Compare keyword search results across categories
- Export ranked product datasets with source links

    ## Common Data

    Depending on what is visible and authorized, relevant fields can include:

    - Keyword, rank, product title, URL, price, points, shop, rating, and review count
- Coupon labels, shipping, category context, image, and source URL
...
separate approval for dependency installation.
    ...
    - "Run rakuten-search-results-scraper and export the visible records to a table."
- "Collect rakuten search results scraper data from these URLs."
- "Research these targets with rakuten-search-results-scraper and include source links."
