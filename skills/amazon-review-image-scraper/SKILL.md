    ---
    name: amazon-review-image-scraper
    description: "Collect Amazon review images — review text, rating, image references, author, date. Use when the user wants visual review or UGC analysis."
    license: MIT
    metadata:
    ...
    # Amazon Review Image Scraper

    Use this Skill for Amazon review image collection, UGC research, and product quality analysis.
    ...
    - Collect visible customer images from Amazon reviews
- Research visual proof, product defects, use cases, and packaging issues
- Compare review images across competing listings
- Export source-linked image review records

    ## Common Data

    Depending on what is visible and authorized, relevant fields can include:

    - Review URL, rating, review text, author, date, image references, and helpful votes
- Product title, ASIN, variant context, and review filters
- Image captions or surrounding text when visible
...
separate approval for dependency installation.
    ...
    - "Run amazon-review-image-scraper and export the visible records to a table."
- "Collect amazon review image scraper data from these URLs."
- "Research these targets with amazon-review-image-scraper and include source links."
