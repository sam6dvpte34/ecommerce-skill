---
name: google-shopping-price-comparison-scraper
...
# Google Shopping Price Comparison Scraper with BrowserAct

Use this Skill for Google Shopping price comparison collection.
...
- "Compare these Google Shopping product pages by price, seller, stock, shipping, and source URL."
