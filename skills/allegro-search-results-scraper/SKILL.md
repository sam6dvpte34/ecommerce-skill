---
name: allegro-search-results-scraper
description: "Collect search results from Allegro — product titles, prices, ratings, URLs, sponsored flags. Use when the user wants to collect listings matching a keyword or category."
---

# Allegro Search Results Scraper with BrowserAct

Use this Skill for Allegro search result collection.
...
- "Scrape Allegro search results for this keyword and export product titles, prices, positions, and URLs."
- "Collect search results from these Allegro URLs and return a table."
