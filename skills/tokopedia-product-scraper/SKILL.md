    ...
    description: "Collect Tokopedia product pages — title, price, seller, sold count, rating, reviews. Use when the user wants Indonesia marketplace research."
    license: MIT
    metadata:
    ...
    Use this Skill for Tokopedia product scraping, Indonesian marketplace research, and seller analysis.
    ...
    - Collect visible Tokopedia product details
- Research price, seller, sold count, rating, and reviews
- Compare products and stores in Indonesian marketplace categories
...
- Shipping, badges, promotions, location, and images
...
separate approval for dependency installation.
    ...
    - "Run tokopedia-product-scraper and export the visible records to a table."
- "Collect tokopedia product scraper data from these URLs."
- "Research these targets with tokopedia-product-scraper and include source links."
