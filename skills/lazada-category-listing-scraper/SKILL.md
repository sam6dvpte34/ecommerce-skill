---
name: lazada-category-listing-scraper
...
# Lazada Category Listing Scraper with BrowserAct

Use this Skill for Lazada category listing collection.
...
- "Scrape this Lazada listing page and export visible product cards with prices and source URLs."
- "Collect category listings from these Lazada URLs and return a table."
