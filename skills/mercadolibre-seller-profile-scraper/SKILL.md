---
name: mercadolibre-seller-profile-scraper
description: "Collect seller profiles from MercadoLibre — seller name, rating, review count, product catalog. Use when the user wants to research sellers or build supplier lead lists."
---

# MercadoLibre Seller Profile Scraper with BrowserAct

Use this Skill for MercadoLibre seller profile collection.
...
- "Scrape this MercadoLibre seller or supplier profile and export visible profile information."
- "Collect seller references from these MercadoLibre pages and return a table."
