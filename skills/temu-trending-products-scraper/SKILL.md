---
name: temu-trending-products-scraper
description: "Collect trending products from Temu — product titles, trending signals, category. Use when the user wants to spot trending products and rising demand."
---

# Temu Trending Products Scraper with BrowserAct

Use this Skill for Temu trending product collection.
...
- Collect bestseller, trending, ranking, or new-arrival product lists
- Research ranked products, category movement, and visible demand signals
- Compare rankings across categories, time windows, or regions
- Export source-linked ranking datasets for product research

## Common Data

Depending on what is visible and authorized, relevant fields can include:

- Rank, category, list name, time window, page number, and visible ranking context
- Product title, brand, price, currency, rating, review count, badges, and availability
- Seller, offer, thumbnail, promotion, and product reference when visible
- Ranking page URL, product URL, source URL, and capture timestamp
...
- "Scrape this Temu ranking page and export rank, product title, price, rating, and source URL."
- "Collect bestseller, trending, or new-arrival items from these Temu pages."
- "Find top visible products in this category and return a ranked table."
- "Compare these ranking pages by product mix, price range, and visible demand signals."
