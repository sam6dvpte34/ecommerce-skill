---
name: noon-review-scraper
description: "Collect reviews from Noon — text, rating, author, date, verified status. Use when the user wants to collect reviews for sentiment analysis or quality research."
---

# Noon Review Scraper with BrowserAct

Use this Skill for Noon review collection.
...
- "Scrape visible Noon reviews and export rating, review text, date, and source URL."
- "Collect reviews from these Noon pages and return a table."
