...
# Ecommerce Price Monitor with BrowserAct

Use this Skill for Price monitoring across product pages or listings.
...
- "Monitor this ecommerce page for visible price, stock, discount, and availability changes."
- "Collect current price and availability data from these ecommerce URLs."
