---
name: aliexpress-listings-scraper
description: "Collect listings from AliExpress — title, price, condition, seller, URL. Use when the user wants to collect product or offer listings."
---

# AliExpress Listings Scraper with BrowserAct

Use this Skill for AliExpress listing collection.
...
- "Scrape this AliExpress listing page and export visible product cards with prices and source URLs."
- "Collect category listings from these AliExpress URLs and return a table."
