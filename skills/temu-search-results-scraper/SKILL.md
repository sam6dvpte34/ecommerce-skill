---
name: temu-search-results-scraper
description: "Collect search results from Temu — product titles, prices, ratings, URLs, sponsored flags. Use when the user wants to collect listings matching a keyword or category."
---

# Temu Search Results Scraper with BrowserAct

Use this Skill for Temu search result collection.
...
- "Scrape Temu search results for this keyword and export product titles, prices, positions, and URLs."
- "Collect search results from these Temu URLs and return a table."
