---
name: lazada-product-scraper
description: "Collect products from Lazada — title, price, specs, images, availability. Use when the user wants to research products or collect catalog data."
---

# Lazada Product Scraper with BrowserAct

Use this Skill for Lazada product collection.
...
- "Scrape this Lazada page and export title, price, availability, rating, seller, and source URL."
- "Collect Lazada product or listing details from these URLs and return a table."
- "Find visible price, stock, variant, promotion, and seller data from these pages."
- "Compare these Lazada pages and return seller, price, shipping, and source differences."
