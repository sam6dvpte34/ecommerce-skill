---
name: consumer-affairs-review-scraper
description: "Collect reviews from ConsumerAffairs — text, rating, author, date, verified status. Use when the user wants to collect reviews for sentiment analysis or quality research."
---

# ConsumerAffairs Review Scraper with BrowserAct

Use this Skill for ConsumerAffairs review collection.
...
- "Scrape visible ConsumerAffairs reviews and export rating, review text, date, and source URL."
- "Collect reviews from these ConsumerAffairs pages and return a table."
