---
name: farfetch-product-scraper
description: "Collect products from Farfetch — title, price, specs, images, availability. Use when the user wants to research products or collect catalog data."
---

# Farfetch Product Scraper with BrowserAct

Use this Skill for Farfetch product collection.
...
- "Scrape this Farfetch page and export title, price, availability, rating, seller, and source URL."
- "Collect Farfetch product or listing details from these URLs and return a table."
- "Find visible price, stock, variant, promotion, and seller data from these pages."
- "Compare these Farfetch pages and return seller, price, shipping, and source differences."
