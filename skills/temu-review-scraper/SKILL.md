---
name: temu-review-scraper
description: "Collect reviews from Temu — text, rating, author, date, verified status. Use when the user wants to collect reviews for sentiment analysis or quality research."
---

# Temu Review Scraper with BrowserAct

Use this Skill for Temu review collection.
...
- "Scrape visible Temu reviews and export rating, review text, date, and source URL."
- "Collect reviews from these Temu pages and return a table."
