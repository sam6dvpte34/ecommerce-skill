---
name: tiktok-shop-product-scraper
description: "Collect products from TikTok Shop — title, price, specs, images, availability. Use when the user wants to research products or collect catalog data."
---

# TikTok Shop Product Scraper with BrowserAct

Use this Skill for TikTok Shop product collection.
...
- "Scrape this TikTok Shop page and export title, price, availability, rating, seller, and source URL."
- "Collect TikTok Shop product or listing details from these URLs and return a table."
- "Find visible price, stock, variant, promotion, and seller data from these pages."
- "Compare these TikTok Shop pages and return seller, price, shipping, and source differences."
