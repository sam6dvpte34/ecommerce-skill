...
- "Scrape this Walmart listing page and export visible product cards with prices and source URLs."
- "Collect category listings from these Walmart URLs and return a table."
