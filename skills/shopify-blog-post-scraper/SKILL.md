    ---
    name: shopify-blog-post-scraper
    description: "Collect Shopify blog posts — title, author, date, tags, content, product links. Use when the user wants content marketing or SEO research."
    license: MIT
    metadata:
    ...
    # Shopify Blog Post Scraper

    Use this Skill for Shopify blog content extraction, content marketing research, and SEO competitor analysis.
    ...
    - Collect blog posts from Shopify storefronts
- Analyze content themes, publishing cadence, and product links
- Research competitor SEO and education content
- Export blog post records for content analysis

    ## Common Data

    Depending on what is visible and authorized, relevant fields can include:

    - Post title, URL, author, publish date, tags, body text, and images
- Internal product links, collection links, comments when visible, and canonical URL
- Store domain and source references
...
separate approval for dependency installation.
    ...
    - "Run shopify-blog-post-scraper and export the visible records to a table."
- "Collect shopify blog post scraper data from these URLs."
- "Research these targets with shopify-blog-post-scraper and include source links."
