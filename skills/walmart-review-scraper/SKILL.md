---
name: walmart-review-scraper
description: "Collect reviews from Walmart — text, rating, author, date, verified status. Use when the user wants to collect reviews for sentiment analysis or quality research."
---

# Walmart Review Scraper with BrowserAct

Use this Skill for Walmart review collection.
...
- "Scrape visible Walmart reviews and export rating, review text, date, and source URL."
- "Collect reviews from these Walmart pages and return a table."
