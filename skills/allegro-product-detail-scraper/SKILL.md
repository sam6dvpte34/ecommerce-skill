---
name: allegro-product-detail-scraper
...
# Allegro Product Detail Scraper with BrowserAct

Use this Skill for Allegro product detail collection.
...
- "Scrape this Allegro page and export title, price, availability, rating, seller, and source URL."
- "Collect Allegro product or listing details from these URLs and return a table."
- "Find visible price, stock, variant, promotion, and seller data from these pages."
- "Compare these Allegro pages and return seller, price, shipping, and source differences."
