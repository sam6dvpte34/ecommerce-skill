---
name: ebay-seller-profile-scraper
description: "Collect seller profiles from eBay — seller name, rating, review count, product catalog. Use when the user wants to research sellers or build supplier lead lists."
---

# eBay Seller Profile Scraper with BrowserAct

Use this Skill for eBay seller profile collection.
...
- "Scrape this eBay seller or supplier profile and export visible profile information."
- "Collect seller references from these eBay pages and return a table."
