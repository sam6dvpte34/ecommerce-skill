    ---
    name: amazon-buy-box-monitor
    description: "Monitor Amazon Buy Box state — winning seller, price, fulfillment, availability, timestamp. Use when the user wants seller competition or pricing watchlists."
    license: MIT
    metadata:
    ...
    Use this Skill for Amazon Buy Box monitoring, seller competition tracking, and marketplace offer analysis.
    ...
    - Track Buy Box seller and price changes for selected ASINs
- Compare Amazon offers by seller, fulfillment, price, and availability
- Monitor competitor seller movement over repeated snapshots
- Export timestamped Buy Box records with source links

    ## Common Data

    Depending on what is visible and authorized, relevant fields can include:

    - ASIN, product title, Buy Box seller, price, shipping, fulfillment, and availability
- Other visible offers, seller ratings, delivery promise, and promotion labels
...
separate approval for dependency installation.
    ...
    - "Run amazon-buy-box-monitor and export the visible records to a table."
- "Collect amazon buy box monitor data from these URLs."
- "Research these targets with amazon-buy-box-monitor and include source links."
