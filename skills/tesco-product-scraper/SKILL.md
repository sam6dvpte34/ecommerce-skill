---
name: tesco-product-scraper
description: "Collect products from Tesco — title, price, specs, images, availability. Use when the user wants to research products or collect catalog data."
---

# Tesco Product Scraper with BrowserAct

Use this Skill for Tesco product collection.
...
- "Scrape this Tesco page and export title, price, availability, rating, seller, and source URL."
- "Collect Tesco product or listing details from these URLs and return a table."
- "Find visible price, stock, variant, promotion, and seller data from these pages."
- "Compare these Tesco pages and return seller, price, shipping, and source differences."
