---
name: ecommerce-search-results-scraper
...
# Ecommerce Search Results Scraper with BrowserAct

Use this Skill for Generic ecommerce search result collection.
...
- "Scrape ecommerce search results for this keyword and export product titles, prices, positions, and URLs."
- "Collect search results from these ecommerce URLs and return a table."
