---
name: made-in-china-product-scraper
description: "Collect products from Made-in-China — title, price, specs, images, availability. Use when the user wants to research products or collect catalog data."
---

# Made-in-China Product Scraper with BrowserAct

Use this Skill for Made-in-China product collection.
...
- "Scrape this Made-in-China page and export title, price, availability, rating, seller, and source URL."
- "Collect Made-in-China product or listing details from these URLs and return a table."
- "Find visible price, stock, variant, promotion, and seller data from these pages."
- "Compare these Made-in-China pages and return seller, price, shipping, and source differences."
