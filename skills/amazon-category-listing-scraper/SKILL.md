---
name: amazon-category-listing-scraper
description: "Collect category listings from Amazon — product titles, prices, ratings, category filters. Use when the user wants to collect products from a category or browse page."
---

# Amazon Category Listing Scraper with BrowserAct

Use this Skill for Amazon category listing collection.
...
- "Scrape this Amazon listing page and export visible product cards with prices and source URLs."
- "Collect category listings from these Amazon URLs and return a table."
