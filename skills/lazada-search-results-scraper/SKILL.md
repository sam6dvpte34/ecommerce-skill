---
name: lazada-search-results-scraper
description: "Collect search results from Lazada — product titles, prices, ratings, URLs, sponsored flags. Use when the user wants to collect listings matching a keyword or category."
---

# Lazada Search Results Scraper with BrowserAct

Use this Skill for Lazada search result collection.
...
- "Scrape Lazada search results for this keyword and export product titles, prices, positions, and URLs."
- "Collect search results from these Lazada URLs and return a table."
