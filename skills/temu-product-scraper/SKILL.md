...
description: "Collect products from Temu — title, price, specs, images, availability. Use when the user wants to research products or collect catalog data."
---

# Temu Product Scraper with BrowserAct

Use this Skill for Temu product collection.
...
- "Scrape this Temu page and export title, price, availability, rating, seller, and source URL."
- "Collect Temu product or listing details from these URLs and return a table."
- "Find visible price, stock, variant, promotion, and seller data from these pages."
- "Compare these Temu pages and return seller, price, shipping, and source differences."
