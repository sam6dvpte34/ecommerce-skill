---
name: aliexpress-review-scraper
description: "Collect reviews from AliExpress — text, rating, author, date, verified status. Use when the user wants to collect reviews for sentiment analysis or quality research."
---

# AliExpress Review Scraper with BrowserAct

Use this Skill for AliExpress review collection.
...
- "Scrape visible AliExpress reviews and export rating, review text, date, and source URL."
- "Collect reviews from these AliExpress pages and return a table."
