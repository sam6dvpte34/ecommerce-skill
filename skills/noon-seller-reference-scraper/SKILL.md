---
name: noon-seller-reference-scraper
description: "Collect seller references from Noon — seller name, ratings, product listing count. Use when the user wants to collect seller reference data for vetting or comparison."
---

# Noon Seller Reference Scraper with BrowserAct

Use this Skill for Noon seller reference collection.
...
- "Scrape this Noon page and export title, price, availability, rating, seller, and source URL."
- "Collect Noon product or listing details from these URLs and return a table."
- "Find visible price, stock, variant, promotion, and seller data from these pages."
- "Compare these Noon pages and return seller, price, shipping, and source differences."
